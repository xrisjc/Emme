...
namespace Emme.Models
{
    ...
    public class GapBuffer<T> where T : struct
    {
        ...
        /// </summary>
        private int ToBufferIndex(int contentIndex)
        {
            return (contentIndex >= gap.Start) ? contentIndex + gap.Length : contentIndex;
        }
        ...
        {
            get { return buffer[ToBufferIndex(index)]; }
            set { buffer[ToBufferIndex(index)] = value; }
        }
